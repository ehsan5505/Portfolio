      ...
      <div class="row work">
        ...
        <div class="large-12 columns">
          ...
          <ul class="clearing-thumbs small-block-grid-1 medium-block-grid-2 large-block-grid-4" data-clearing>
            <li>
              <a href="?nav=prog"><img data-caption="Programming" src="/img/osd.png"></a>
            </li>
            <li>
              <a href="?nav=elect"><img data-caption="Electronics" src="/img/rasp.jpeg"></a>
            </li>
            <li>
              <a href="?nav=prj"><img data-caption="Projects..." src="/img/project.jpg"></a>
            </li>
            <li>
              <a href="?nav=exp"><img data-caption="Experience" src="/img/gfkEtilize.png"></a>
            </li>
          </ul>
        </div>
      </div>
